...
export class UserService {
  constructor(
    ...
    private socialMediaUserRepo: Repository<SocialMediaUser>,
  ) {}
  ...
  async getSocialMediaUserById(
    userId: string,
    provider: string,
  ): Promise<SocialMediaUser> {
    return this.socialMediaUserRepo.findOneBy([
      { provider: provider, socialMediaId: userId },
    ]);
  }
